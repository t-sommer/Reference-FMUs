use crate::{
    ...
    sim::fmi3::{SimulationResult, Trajectory},
};
        ...
        for (i, variable) in self.simulation_result.variables.iter().enumerate() {
            ...
            match variable.variableType {
                VariableType::Float32 => {
                    ...
                    if let Trajectory::Float32(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                ...
                VariableType::Float64 => {
                    ...
                    if let Trajectory::Float64(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Int8 => {
                    ...
                    if let Trajectory::Int8(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::UInt8 => {
                    ...
                    if let Trajectory::UInt8(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Int16 => {
                    ...
                    if let Trajectory::Int16(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::UInt16 => {
                    ...
                    if let Trajectory::UInt16(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Int32 => {
                    ...
                    if let Trajectory::Int32(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::UInt32 => {
                    ...
                    if let Trajectory::UInt32(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Int64 => {
                    ...
                    if let Trajectory::Int64(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::UInt64 => {
                    ...
                    if let Trajectory::UInt64(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Boolean => {
                    ...
                    if let Trajectory::Boolean(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::String => {
                    ...
                    if let Trajectory::String(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
                        trajectory.push(values);
                    } else {
                ...
                VariableType::Binary => {
                    ...
                    self.fmu
                        .getBinary(&value_references, &mut sizes, &mut values);
                    let binary_values: Vec<Vec<u8>> = values
                        ...
                        .collect();
                    if let Trajectory::Binary(trajectory) =
                        &mut self.simulation_result.trajectories[i]
                    {
