...
use crate::{fmi2::FMU2, model_description::{ModelDescription, ModelVariable, Variability}, sim::fmi2::{parse_variable_value, set_variable_value}, types::*, util::VariableValue};
...
impl<'a> CSVInput<'a> {
    ...
    pub fn set_discrete_inputs(&self, time: f64, after_event: bool, fmu: &FMU2) -> Result<(), Box<dyn Error>> {
    ...
    pub fn set_continuous_inputs(&self, time: f64, after_event: bool, fmu: &FMU2) -> Result<(), Box<dyn Error>> {
