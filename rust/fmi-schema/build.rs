fn main() {
    ...
    println!("cargo:rustc-link-search=native={}", library_dir.join("lib").display());
    println!("cargo:rustc-link-arg=/WHOLEARCHIVE:{}", library_dir.join("lib/libxml2s.lib").display());
